package com.github.caioorleans.security.JWT;
...
public class JwtTokenProvider {
	...
	@PostConstruct //Vai ser chamado somente após a injeção das dependência
	protected void init() {
	...
	public Authentication getAuthentication(String token) {
		...
		UserDetails userDetails = 
				this.userDetailService.loadUserByUsername(decodedJWT.getSubject());
	...
	public boolean validateToken(String token) {
		...
		try {
			...
			throw new InvalidJwtAuthenticationExcepion("Expired or invalid JWT token");
		}
	}
